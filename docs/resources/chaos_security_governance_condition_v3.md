...
- `namespace_labels` (Map of String) Namespace labels to match against, as key-value pairs
...
terraform import harness_chaos_security_governance_condition_v3.example org_id/project_id/condition_id
```
