...
terraform import harness_platform_gitops_app_project.example <account.agent_id>/<app_proj_name>

# Import gitOps project with org level agent
terraform import harness_platform_gitops_app_project.example <organization_id>/<org.agent_id>/<app_proj_name>
