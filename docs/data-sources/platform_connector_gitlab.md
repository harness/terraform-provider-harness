...
page_title: "harness_platform_connector_gitlab Data Source - terraform-provider-harness"
subcategory: "Next Gen"
description: |-
  Datasource for looking up a Gitlab connector.
---

# harness_platform_connector_gitlab (Data Source)
...
```terraform
data "harness_platform_connector_gitlab" "example" {
