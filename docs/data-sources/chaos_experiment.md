...
- `import_type` (String) Import type (REFERENCE or LOCAL)
...
- `template_details` (List of Object) Template details for REFERENCE imports (see [below for nested schema](#nestedatt--template_details))
