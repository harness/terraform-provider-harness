...
- `org_id` (String) Organization identifier. Leave empty for account-level templates.
- `project_id` (String) Project identifier. Leave empty for account and org-level templates.
