		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "prometheus.0.url", "https://prometheus.com/"),
					resource.TestCheckResourceAttr(resourceName, "prometheus.0.delegate_selectors.#", "1"),
				),
			},
			{
