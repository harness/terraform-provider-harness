...
// 		resourceName = "data.harness_platform_connector.test"
// 	)
...
// 	return fmt.Sprintf(`
// 		resource "harness_platform_connector" "test" {
// 			identifier = "%[1]s"
// 			name = "%[1]s"
...
// 		data "harness_platform_connector" "test" {
// 			identifier = harness_platform_connector.test.identifier
// 		}
// 	`, name)
// }
