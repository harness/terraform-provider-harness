...
func TestAccDataSourceRoleAssignmentsProjectLevel(t *testing.T) {
	...
	resource.UnitTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccDataSourceRoleAssignmentsProjectLevel(id, name, accountId),
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr(resourceName, "id", id),
					resource.TestCheckResourceAttr(resourceName, "identifier", id),
...
func TestAccDataSourceRoleAssignmentsOrgLevel(t *testing.T) {
	...
	resource.UnitTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccDataSourceRoleAssignmentsOrgLevel(id, name, accountId),
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr(resourceName, "id", id),
					resource.TestCheckResourceAttr(resourceName, "identifier", id),
					resource.TestCheckResourceAttr(resourceName, "resource_group_identifier", "_all_organization_level_resources"),
					resource.TestCheckResourceAttr(resourceName, "disabled", "false"),
					resource.TestCheckResourceAttr(resourceName, "managed", "false"),
					resource.TestCheckResourceAttr(resourceName, "principal.0.type", "SERVICE_ACCOUNT"),
				),
...
func testAccDataSourceRoleAssignmentsProjectLevel(id string, name string, accountId string) string {
	return fmt.Sprintf(`
	...
	resource "time_sleep" "wait_5_seconds" {
		depends_on = [harness_platform_service_account.test]
		create_duration = "4s"
	}
...
func testAccDataSourceRoleAssignmentsOrgLevel(id string, name string, accountId string) string {
	return fmt.Sprintf(`
	resource "harness_platform_organization" "test" {
		identifier = "%[1]s"
		name = "%[1]s"
