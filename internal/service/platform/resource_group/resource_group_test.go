		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "resource_filter.0.resources.0.identifiers.0", "QA"),
					resource.TestCheckResourceAttr(resourceName, "resource_filter.0.resources.0.identifiers.1", "Prod-1"),
				),
			},
		},
	})
