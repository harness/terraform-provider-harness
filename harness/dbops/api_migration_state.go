...
type MigrationStateApiService service

/*
MigrationStateApiService Migration state of a schema
Migration state of a schema
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param org Organization identifier
 * @param project Project identifier
 * @param dbschema Identifier of the database schema
 * @param optional nil or *MigrationStateApiV1MigrationStateProjDbSchemaOpts - Optional Parameters:
     * @param "Body" (optional.Interface of MigrationStateIn) -  Inputs to get migration state of schema
...
type MigrationStateApiV1MigrationStateProjDbSchemaOpts struct {
...
func (a *MigrationStateApiService) V1MigrationStateProjDbSchema(ctx context.Context, org string, project string, dbschema string, localVarOptionals *MigrationStateApiV1MigrationStateProjDbSchemaOpts) (MigrationStateOut, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue MigrationStateOut
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/orgs/{org}/projects/{project}/dbschema/{dbschema}/migrationstate"
