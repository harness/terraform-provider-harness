...
func (a *GitXWebhooksApiService) DeleteGitxWebhook(ctx context.Context, gitxWebhook string, localVarOptionals *GitXWebhooksApiDeleteGitxWebhookOpts) (*http.Response, error) {
	var (
