...
func (a *ConnectorInfo) UnmarshalJSON(data []byte) error {
	...
	case ConnectorTypes.AzureArtifacts:
		err = json.Unmarshal(aux.Spec, &a.AzureArtifacts)
	...
	case ConnectorTypes.AzureRepo:
		err = json.Unmarshal(aux.Spec, &a.AzureRepo)
...
func (a *ConnectorInfo) MarshalJSON() ([]byte, error) {
	...
	case ConnectorTypes.AzureRepo:
		spec, err = json.Marshal(a.AzureRepo)
	case ConnectorTypes.Vault:
	...
	case ConnectorTypes.AzureArtifacts:
		spec, err = json.Marshal(a.AzureArtifacts)
	case ConnectorTypes.AzureKeyVault:
