...
/*
UserApiService Add Users to user groups
Adds the users to the specified user group IDs passed in the body and removes all other user groups for user except harness managed user groups
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param accountIdentifier Account Identifier for the Entity.
 * @param userId User Identifier
 * @param optional nil or *UserApiAddUserToUserGroupsOpts - Optional Parameters:
     * @param "Body" (optional.Interface of UserAddToUserGroupDto) -
...
func (a *UserApiService) AddUserToUserGroups(ctx context.Context, accountIdentifier string, userId string, localVarOptionals *UserApiAddUserToUserGroupsOpts) (ResponseDtoBoolean, *http.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/ng/api/user/add-user-to-groups/{userId}"
	...
	if localVarOptionals != nil {
		...
		localVarOptionalBody := localVarOptionals.Body
...
/*
UserApiService Reset two factor authorization
...
func (a *UserApiService) Reset2fa(ctx context.Context, userId string, accountIdentifier string) (RestResponseBoolean, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/ng/api/user/reset-two-factor-auth/{userId}"
	localVarPath = strings.Replace(localVarPath, "{"+"userId"+"}", fmt.Sprintf("%v", userId), -1)
 ...
 * @param accountIdentifier Account Identifier for the Entity.
 * @param userId User Identifier
 * @param optional nil or *UserApiUpdateUserInfo1Opts - Optional Parameters:
     * @param "Body" (optional.Interface of UserInfoUpdateDto) -
@return ResponseDtoUserInfo
*/
