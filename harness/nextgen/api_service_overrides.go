...
/*
ServiceOverridesApiService Gets Service Override List
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc.
Passed from http.Request or context.Background().
 * @param accountIdentifier
 * @param optional nil or *ServiceOverridesApiGetServiceOverrideListV2Opts - Optional Parameters:
     * @param "Page" (optional.Int32) -
     * @param "Size" (optional.Int32) -
     * @param "OrgIdentifier" (optional.String) -
     * @param "ProjectIdentifier" (optional.String) -
     * @param "Type_" (optional.String) -
@return ResponsePageServiceOverridesResponseDtov2
*/

type ServiceOverridesApiGetServiceOverrideListV2Opts struct {
	Page              optional.Int32
	Size              optional.Int32
	OrgIdentifier     optional.String
	ProjectIdentifier optional.String
...
func (a *ServiceOverridesApiService) GetServiceOverrideListV2(ctx context.Context, accountIdentifier string, localVarOptionals *ServiceOverridesApiGetServiceOverrideListV2Opts) (ResponsePageServiceOverridesResponseDtov2, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue ResponsePageServiceOverridesResponseDtov2
	)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v ResponsePageServiceOverridesResponseDtov2
			err = a.client.decode(&v, localVarBody,
				localVarHttpResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
...
/*
ServiceOverridesApiService Upsert an ServiceOverride Entity
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc.
Passed from http.Request or context.Background().
 * @param accountIdentifier
 * @param optional nil or *ServiceOverridesApiUpsertServiceOverrideV2Opts - Optional Parameters:
     * @param "Body" (optional.Interface of ServiceOverrideRequestDtov2) -
@return ResponseServiceOverridesResponseDtov2
*/

type ServiceOverridesApiUpsertServiceOverrideV2Opts struct {
	Body optional.Interface
}

func (a *ServiceOverridesApiService) UpsertServiceOverrideV2(ctx context.Context, accountIdentifier string, localVarOptionals *ServiceOverridesApiUpsertServiceOverrideV2Opts) (ResponseServiceOverridesResponseDtov2, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
