...
/*
ValidateHostApiService Validates hosts connectivity using SSH credentials
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body List of SSH hosts to validate
 * @param accountIdentifier Account Identifier for the Entity.
 * @param identifier Secret Identifier
 * @param optional nil or *ValidateHostApiValidateSshHostsOpts - Optional Parameters:
...
func (a *ValidateHostApiService) ValidateSshHosts(ctx context.Context, body []string, accountIdentifier string, identifier string, localVarOptionals *ValidateHostApiValidateSshHostsOpts) (ResponseDtoListHostValidationDto, *http.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/ng/api/host-validation/ssh"
