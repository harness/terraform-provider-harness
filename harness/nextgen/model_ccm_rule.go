...
type CcmRule struct {
	...
	// isStablePolicy
	IsStablePolicy bool `json:"isStablePolicy,omitempty"`
	// storeType
	...
	// forRecommendation
	ForRecommendation bool `json:"forRecommendation,omitempty"`
	// resourceType
	ResourceType string `json:"resourceType,omitempty"`
	// isMultiPolicyRule
	IsMultiPolicyRule bool `json:"isMultiPolicyRule,omitempty"`
	// subRulePolicyDetails
	SubRulePolicyDetails []SubRulePolicyDetails `json:"subRulePolicyDetails,omitempty"`
