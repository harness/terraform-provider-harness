...
> InlineResponse2006 GetDockerArtifactIntegrationDetails(ctx, registryRef, artifact, version, digest)
...
> InlineResponse2007 GetDockerArtifactLayers(ctx, registryRef, artifact, version, digest)
...
> InlineResponse2008 GetDockerArtifactManifest(ctx, registryRef, artifact, version, digest)
...
> InlineResponse2009 GetDockerArtifactManifests(ctx, registryRef, artifact, version)
