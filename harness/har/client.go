...
// APIClient manages communication with the Harness Artifact Registry API API v1.0.0
...
type APIClient struct {
	...
	DockerArtifactsApi *DockerArtifactsApiService

	HelmArtifactsApi *HelmArtifactsApiService
