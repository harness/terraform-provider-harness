...
type V1PodStatus struct {
	...
	// The list has one entry per container in the manifest. More info: https://kubernetes.io/docs/concepts/workloads/pods/pod-lifecycle#pod-and-container-status +optional
	ContainerStatuses []V1ContainerStatus `json:"containerStatuses,omitempty"`
	// Status for any ephemeral containers that have run in this pod. +optional
	EphemeralContainerStatuses []V1ContainerStatus `json:"ephemeralContainerStatuses,omitempty"`
	...
	PodIPs []V1PodIp `json:"podIPs,omitempty"`
