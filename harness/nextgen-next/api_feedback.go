...
/*
FeedbackApiService Saves Feedback
...
type FeedbackApiSaveFeedbackOpts struct {
	Body              optional.Interface
	AccountIdentifier optional.String
}

func (a *FeedbackApiService) SaveFeedback(ctx context.Context, localVarOptionals *FeedbackApiSaveFeedbackOpts) (ResponseDtoBoolean, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/ng/api/feedback"
