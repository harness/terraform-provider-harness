...
/*
HarnessResourceGroupApiService Create Resource Group
Create a resource group
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body This contains the details required to create a Resource Group
 * @param accountIdentifier Account Identifier for the Entity.
 * @param optional nil or *HarnessResourceGroupApiCreateResourceGroupV2Opts - Optional Parameters:
     * @param "OrgIdentifier" (optional.String) -  Organization Identifier for the Entity.
     * @param "ProjectIdentifier" (optional.String) -  Project Identifier for the Entity.
...
func (a *HarnessResourceGroupApiService) CreateResourceGroupV2(ctx context.Context, body ResourceGroupV2Request, accountIdentifier string, localVarOptionals *HarnessResourceGroupApiCreateResourceGroupV2Opts) (ResponseDtoResourceGroupV2Response, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue ResponseDtoResourceGroupV2Response
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/resourcegroup/api/v2/resourcegroup"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 0 {
			var v ResponseDtoResourceGroupV2Response
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
					return localVarReturnValue, localVarHttpResponse, newErr
...
/*
HarnessResourceGroupApiService Delete Resource Group
Delete a resource group
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param identifier Identifier for the Entity.
 * @param accountIdentifier Account Identifier for the Entity.
 * @param optional nil or *HarnessResourceGroupApiDeleteResourceGroupV2Opts - Optional Parameters:
     * @param "OrgIdentifier" (optional.String) -  Organization Identifier for the Entity.
     * @param "ProjectIdentifier" (optional.String) -  Project Identifier for the Entity.
@return ResponseDtoBoolean
*/
...
func (a *HarnessResourceGroupApiService) DeleteResourceGroupV2(ctx context.Context, identifier string, accountIdentifier string, localVarOptionals *HarnessResourceGroupApiDeleteResourceGroupV2Opts) (ResponseDtoBoolean, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/resourcegroup/api/v2/resourcegroup/{identifier}"
	localVarPath = strings.Replace(localVarPath, "{"+"identifier"+"}", fmt.Sprintf("%v", identifier), -1)
...
/*
HarnessResourceGroupApiService This fetches a filtered list of Resource Groups
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
...
/*
HarnessResourceGroupApiService List Resource Groups by filter
This fetches a filtered list of Resource Groups
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body Filter Resource Groups based on multiple parameters
 * @param accountIdentifier Account Identifier for the Entity.
 * @param optional nil or *HarnessResourceGroupApiGetFilterResourceGroupListV2Opts - Optional Parameters:
     * @param "PageIndex" (optional.Int32) -  Page Index of the results to fetch.Default Value: 0
     * @param "PageSize" (optional.Int32) -  Results per page(max 100)Default Value: 50
     * @param "SortOrders" (optional.Interface of []SortOrder) -  Sort criteria for the elements.
...
func (a *HarnessResourceGroupApiService) GetFilterResourceGroupListV2(ctx context.Context, body ResourceGroupFilter, accountIdentifier string, localVarOptionals *HarnessResourceGroupApiGetFilterResourceGroupListV2Opts) (ResponseDtoPageResponseResourceGroupV2Response, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue ResponseDtoPageResponseResourceGroupV2Response
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/resourcegroup/api/v2/resourcegroup/filter"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 0 {
			var v ResponseDtoPageResponseResourceGroupV2Response
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
					return localVarReturnValue, localVarHttpResponse, newErr
...
/*
HarnessResourceGroupApiService List Resource Groups
Get list of resource groups
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param accountIdentifier Account Identifier for the Entity.
 * @param optional nil or *HarnessResourceGroupApiGetResourceGroupListV2Opts - Optional Parameters:
     * @param "OrgIdentifier" (optional.String) -  Organization Identifier for the Entity.
     * @param "ProjectIdentifier" (optional.String) -  Project Identifier for the Entity.
     * @param "SearchTerm" (optional.String) -  Details of all the resource groups having this string in their name or identifier will be returned.
     * @param "PageIndex" (optional.Int32) -  Page Index of the results to fetch.Default Value: 0
...
func (a *HarnessResourceGroupApiService) GetResourceGroupListV2(ctx context.Context, accountIdentifier string, localVarOptionals *HarnessResourceGroupApiGetResourceGroupListV2Opts) (ResponseDtoPageResponseResourceGroupV2Response, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
HarnessResourceGroupApiService Get Resource Group
Get a resource group by identifier
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param identifier Identifier for the Entity.
 * @param accountIdentifier Account Identifier for the Entity.
 * @param optional nil or *HarnessResourceGroupApiGetResourceGroupV2Opts - Optional Parameters:
     * @param "OrgIdentifier" (optional.String) -  Organization Identifier for the Entity.
     * @param "ProjectIdentifier" (optional.String) -  Project Identifier for the Entity.
@return ResponseDtoResourceGroupV2Response
*/
...
func (a *HarnessResourceGroupApiService) GetResourceGroupV2(ctx context.Context, identifier string, accountIdentifier string, localVarOptionals *HarnessResourceGroupApiGetResourceGroupV2Opts) (ResponseDtoResourceGroupV2Response, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
HarnessResourceGroupApiService Update Resource Group
Update a resource group
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body This contains the details required to create a Resource Group
 * @param accountIdentifier Account Identifier for the Entity.
 * @param identifier Identifier for the Entity.
 * @param optional nil or *HarnessResourceGroupApiUpdateResourceGroup1Opts - Optional Parameters:
     * @param "OrgIdentifier" (optional.String) -  Organization Identifier for the Entity.
     * @param "ProjectIdentifier" (optional.String) -  Project Identifier for the Entity.
@return ResponseDtoResourceGroupV2Response
*/
...
func (a *HarnessResourceGroupApiService) UpdateResourceGroup1(ctx context.Context, body ResourceGroupV2Request, accountIdentifier string, identifier string, localVarOptionals *HarnessResourceGroupApiUpdateResourceGroup1Opts) (ResponseDtoResourceGroupV2Response, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
