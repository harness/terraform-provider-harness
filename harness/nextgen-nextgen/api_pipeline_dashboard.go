...
type PipelineDashboardApiService service
/*
PipelineDashboardApiService Fetch Pipeline Execution Details
...
*/
func (a *PipelineDashboardApiService) GetPipelineExecution(ctx context.Context, accountIdentifier string, orgIdentifier string, projectIdentifier string, pipelineIdentifier string, moduleInfo string, startTime int64, endTime int64) (ResponseDtoDashboardPipelineExecution, *http.Response, error) {
	var (
