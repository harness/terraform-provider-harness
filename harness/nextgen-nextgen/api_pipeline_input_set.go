...
type PipelineInputSetApiService service
/*
PipelineInputSetApiService Delete Input Set
 ...
 * @param optional nil or *PipelineInputSetApiDeleteInputSetOpts - Optional Parameters:
...
type PipelineInputSetApiDeleteInputSetOpts struct {
...
func (a *PipelineInputSetApiService) DeleteInputSet(ctx context.Context, inputSetIdentifier string, accountIdentifier string, orgIdentifier string, projectIdentifier string, pipelineIdentifier string, localVarOptionals *PipelineInputSetApiDeleteInputSetOpts) (ResponseDtoBoolean, *http.Response, error) {
	var (
...
/*
PipelineInputSetApiService Fetch Input Set
 ...
 * @param projectIdentifier Project Identifier for the Entity.
 * @param pipelineIdentifier Pipeline Identifier for the entity.
 * @param optional nil or *PipelineInputSetApiGetInputSetOpts - Optional Parameters:
     * @param "Branch" (optional.String) -  Name of the branch.
     * @param "RepoIdentifier" (optional.String) -  Git Sync Config Id.
...
type PipelineInputSetApiGetInputSetOpts struct {
    Branch optional.String
    RepoIdentifier optional.String
    GetDefaultFromOtherRepo optional.Bool
}

func (a *PipelineInputSetApiService) GetInputSet(ctx context.Context, inputSetIdentifier string, accountIdentifier string, orgIdentifier string, projectIdentifier string, pipelineIdentifier string, localVarOptionals *PipelineInputSetApiGetInputSetOpts) (ResponseDtoInputSetResponse, *http.Response, error) {
	var (
...
/*
PipelineInputSetApiService List Input Sets
 ...
 * @param optional nil or *PipelineInputSetApiListInputSetOpts - Optional Parameters:
     * @param "PageIndex" (optional.Int32) -  Page Index of the results to fetch.Default Value: 0
     * @param "PageSize" (optional.Int32) -  Results per page
...
type PipelineInputSetApiListInputSetOpts struct {
...
func (a *PipelineInputSetApiService) ListInputSet(ctx context.Context, accountIdentifier string, orgIdentifier string, projectIdentifier string, pipelineIdentifier string, localVarOptionals *PipelineInputSetApiListInputSetOpts) (ResponseDtoPageResponseInputSetSummaryResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
PipelineInputSetApiService Create Input Set
 ...
 * @param projectIdentifier Project Identifier for the Entity.
 * @param pipelineIdentifier Pipeline Identifier for the entity.
 * @param optional nil or *PipelineInputSetApiPostInputSetOpts - Optional Parameters:
...
type PipelineInputSetApiPostInputSetOpts struct {
...
func (a *PipelineInputSetApiService) PostInputSet(ctx context.Context, body string, accountIdentifier string, orgIdentifier string, projectIdentifier string, pipelineIdentifier string, localVarOptionals *PipelineInputSetApiPostInputSetOpts) (ResponseDtoInputSetResponse, *http.Response, error) {
	var (
...
/*
PipelineInputSetApiService Update Input Set
 ...
 * @param optional nil or *PipelineInputSetApiPutInputSetOpts - Optional Parameters:
     * @param "IfMatch" (optional.String) -  Version of Entity to match
...
type PipelineInputSetApiPutInputSetOpts struct {
    IfMatch optional.String
    PipelineBranch optional.String
    PipelineRepoID optional.String
    Branch optional.String
...
func (a *PipelineInputSetApiService) PutInputSet(ctx context.Context, body string, accountIdentifier string, orgIdentifier string, projectIdentifier string, pipelineIdentifier string, inputSetIdentifier string, localVarOptionals *PipelineInputSetApiPutInputSetOpts) (ResponseDtoInputSetResponse, *http.Response, error) {
	var (
...
/*
PipelineInputSetApiService Fetch Runtime Input Template
 ...
 * @param optional nil or *PipelineInputSetApiRuntimeInputTemplateOpts - Optional Parameters:
...
type PipelineInputSetApiRuntimeInputTemplateOpts struct {
...
func (a *PipelineInputSetApiService) RuntimeInputTemplate(ctx context.Context, accountIdentifier string, orgIdentifier string, projectIdentifier string, pipelineIdentifier string, localVarOptionals *PipelineInputSetApiRuntimeInputTemplateOpts) (ResponseDtoInputSetTemplateWithReplacedExpressionsResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
