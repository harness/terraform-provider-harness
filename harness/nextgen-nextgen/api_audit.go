...
func (a *AuditApiService) GetAuditEventList(ctx context.Context, accountIdentifier string, localVarOptionals *AuditApiGetAuditEventListOpts) (ResponseDtoPageResponseAuditEvent, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue ResponseDtoPageResponseAuditEvent
	)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 0 {
			var v ResponseDtoPageResponseAuditEvent
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
					return localVarReturnValue, localVarHttpResponse, newErr
