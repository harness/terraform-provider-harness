...
func (a *FeatureFlagsApiService) CreateFeatureFlag(ctx context.Context, accountIdentifier string, orgIdentifier string, localVarOptionals *FeatureFlagsApiCreateFeatureFlagOpts) (FeatureResponseMetadata, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue FeatureResponseMetadata
	)
 ...
 * @param optional nil or *FeatureFlagsApiGetAllFeaturesOpts - Optional Parameters:
     ...
     * @param "TargetIdentifierFilter" (optional.String) -  Identifier of the target to filter on
     ...
     * @param "Status" (optional.String) -  Filter for flags based on their status (active,never-requested,recently-accessed,potentially-stale)
     * @param "Lifetime" (optional.String) -  Filter for flags based on their lifetime (permanent/temporary)
     * @param "Enabled" (optional.Bool) -  Filter for flags based on if they are enabled or disabled
     * @param "FlagCounts" (optional.Bool) -  Returns counts for the different types of flags e.g num active, potentially-stale, recently-accessed etc
@return Features
*/
...
type FeatureFlagsApiGetAllFeaturesOpts struct {
    ...
    TargetIdentifierFilter optional.String
...
func (a *FeatureFlagsApiService) GetAllFeatures(ctx context.Context, accountIdentifier string, orgIdentifier string, projectIdentifier string, localVarOptionals *FeatureFlagsApiGetAllFeaturesOpts) (Features, *http.Response, error) {
	...
	if localVarOptionals != nil && localVarOptionals.TargetIdentifierFilter.IsSet() {
		localVarQueryParams.Add("targetIdentifierFilter", parameterToString(localVarOptionals.TargetIdentifierFilter.Value(), ""))
	}
	...
	if localVarOptionals != nil && localVarOptionals.Lifetime.IsSet() {
		localVarQueryParams.Add("lifetime", parameterToString(localVarOptionals.Lifetime.Value(), ""))
	}
	...
	if localVarOptionals != nil && localVarOptionals.FlagCounts.IsSet() {
		localVarQueryParams.Add("flagCounts", parameterToString(localVarOptionals.FlagCounts.Value(), ""))
	}
	// to determine the Content-Type header
	localVarHttpContentTypes := []string{}
...
func (a *FeatureFlagsApiService) PatchFeature(ctx context.Context, accountIdentifier string, orgIdentifier string, projectIdentifier string, identifier string, localVarOptionals *FeatureFlagsApiPatchFeatureOpts) (FeatureResponseMetadata, *http.Response, error) {
	var (
