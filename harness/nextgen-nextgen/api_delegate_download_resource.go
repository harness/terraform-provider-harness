...
func (a *DelegateDownloadResourceApiService) DownloadDockerDelegateYaml(ctx context.Context, body DelegateDownloadRequest, localVarOptionals *DelegateDownloadResourceApiDownloadDockerDelegateYamlOpts) (*http.Response, error) {
	var (
...
func (a *DelegateDownloadResourceApiService) DownloadKubernetesDelegateYaml(ctx context.Context, body DelegateDownloadRequest, localVarOptionals *DelegateDownloadResourceApiDownloadKubernetesDelegateYamlOpts) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
