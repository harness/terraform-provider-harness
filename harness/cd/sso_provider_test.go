...
func TestGetSSOProviderById_LDAP(t *testing.T) {
	...
	provider, err := client.SSOClient.GetSSOProviderById(id)
...
func TestGetSSOProviderByName_LDAP(t *testing.T) {
	...
	provider, err := client.SSOClient.GetSSOProviderByName(name)
...
func TestListSSOProviders(t *testing.T) {
	...
	for hasMore {
		providers, pagination, err := client.SSOClient.ListSSOProviders(limit, offset)
