...
func TestCacGetApplicationById(t *testing.T) {
	...
	app, err := c.ConfigAsCodeClient.GetApplicationById(testApp.Id)
	require.NoError(t, err)
...
func TestCacGetApplicationByName(t *testing.T) {
	...
	app, err := c.ConfigAsCodeClient.GetApplicationByName(testApp.Name)
	require.NoError(t, err)
	require.NotNil(t, app)
}
...
func TestCacGetApplicationById_DoesNotExist(t *testing.T) {
	...
	app, err := c.ConfigAsCodeClient.GetApplicationById("somenonexistentapp")
