...
func TestCreateSSHCredential_SSHAuthentication_inlinesshkey(t *testing.T) {
	...
	s, err := client.SecretClient.CreateSSHCredential(input)
...
func TestUpdateSSHCredential(t *testing.T) {
	...
	updatedSecret, err := client.SecretClient.UpdateSSHCredential(expectedSecret.Id, input)
...
func TestGetSSHCredentialById_SSHAuth(t *testing.T) {
	...
	client := getClient()
	s, err := client.SecretClient.GetSSHCredentialById(cred.Id)
...
func TestGetSSHCredentialByName_SSHAuth(t *testing.T) {
	...
	client := getClient()
	s, err := client.SecretClient.GetSSHCredentialByName(cred.Name)
...
func TestGetSSHCredentialByName_NotFound(t *testing.T) {
	client := getClient()
	cred, err := client.SecretClient.GetSSHCredentialByName("notfoundcred")
	require.NoError(t, err)
	require.Nil(t, cred)
}
...
func TestListSSHCredentials(t *testing.T) {
	...
	client := getClient()
	creds, err := client.SecretClient.ListSSHCredentials()
	require.NoError(t, err)
