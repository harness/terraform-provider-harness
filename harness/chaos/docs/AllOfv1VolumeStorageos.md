...
**SecretRef** | [***interface{}**](interface{}.md) | SecretRef specifies the secret to use for obtaining the StorageOS API credentials.  If not specified, default values will be attempted. +optional | [optional] [default to null]
