...
**SecretRef** | [***interface{}**](interface{}.md) | Optional: points to a secret object containing parameters used to connect to OpenStack. +optional | [optional] [default to null]
