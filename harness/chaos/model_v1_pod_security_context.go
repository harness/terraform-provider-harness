...
type V1PodSecurityContext struct {
	...
	FsGroupChangePolicy *AllOfv1PodSecurityContextFsGroupChangePolicy `json:"fsGroupChangePolicy,omitempty"`
	...
	SeLinuxOptions *AllOfv1PodSecurityContextSeLinuxOptions `json:"seLinuxOptions,omitempty"`
	// The seccomp options to use by the containers in this pod. +optional
	SeccompProfile *AllOfv1PodSecurityContextSeccompProfile `json:"seccompProfile,omitempty"`
	...
	// The Windows specific settings applied to all containers. If unspecified, the options within a container's SecurityContext will be used. If set in both SecurityContext and PodSecurityContext, the value specified in SecurityContext takes precedence. +optional
	WindowsOptions *AllOfv1PodSecurityContextWindowsOptions `json:"windowsOptions,omitempty"`
}
