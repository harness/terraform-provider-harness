...
/*
DefaultApiService Register a new v2 infra
 ...
 * @param optional nil or *DefaultApiRegisterInfraV2Opts - Optional Parameters:
...
type DefaultApiRegisterInfraV2Opts struct {
    CorrelationID optional.String
}

func (a *DefaultApiService) RegisterInfraV2(ctx context.Context, body InfraV2RegisterInfrastructureV2Request, accountIdentifier string, organizationIdentifier string, projectIdentifier string, localVarOptionals *DefaultApiRegisterInfraV2Opts) (InfraV2RegisterInfrastructureV2Response, *http.Response, error) {
	var (
