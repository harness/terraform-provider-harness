...
/*
RepositoryApiService Soft delete repository
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param accountIdentifier Account Identifier for the Entity..
 * @param repoIdentifier
...
func (a *RepositoryApiService) DeleteRepository(ctx context.Context, accountIdentifier string, repoIdentifier string, localVarOptionals *RepositoryApiDeleteRepositoryOpts) (RepoSoftDeleteResponse, *http.Response, error) {
	var (
		...
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue RepoSoftDeleteResponse
	)
...
/*
RepositoryApiService Purge repository
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param accountIdentifier Account Identifier for the Entity..
 * @param deletedAt The exact time the resource was delete at in epoch format.
 * @param repoIdentifier
 * @param optional nil or *RepositoryApiPurgeRepositoryOpts - Optional Parameters:
     * @param "OrgIdentifier" (optional.String) -  Organization Identifier for the Entity..
     * @param "ProjectIdentifier" (optional.String) -  Project Identifier for the Entity..
...
func (a *RepositoryApiService) PurgeRepository(ctx context.Context, accountIdentifier string, deletedAt int32, repoIdentifier string, localVarOptionals *RepositoryApiPurgeRepositoryOpts) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/repos/{repo_identifier}/purge"
	localVarPath = strings.Replace(localVarPath, "{"+"repo_identifier"+"}", fmt.Sprintf("%v", repoIdentifier), -1)
	...
	localVarQueryParams.Add("deleted_at", parameterToString(deletedAt, ""))
	// to determine the Content-Type header
	localVarHttpContentTypes := []string{}
...
/*
RepositoryApiService Restore repository
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param accountIdentifier Account Identifier for the Entity..
 * @param deletedAt The exact time the resource was delete at in epoch format.
 * @param repoIdentifier
 * @param optional nil or *RepositoryApiRestoreRepositoryOpts - Optional Parameters:
     * @param "Body" (optional.Interface of OpenapiRestoreRequest) -
     * @param "OrgIdentifier" (optional.String) -  Organization Identifier for the Entity..
     * @param "ProjectIdentifier" (optional.String) -  Project Identifier for the Entity..
@return TypesRepository
*/
...
func (a *RepositoryApiService) RestoreRepository(ctx context.Context, accountIdentifier string, deletedAt int32, repoIdentifier string, localVarOptionals *RepositoryApiRestoreRepositoryOpts) (TypesRepository, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/repos/{repo_identifier}/restore"
	localVarPath = strings.Replace(localVarPath, "{"+"repo_identifier"+"}", fmt.Sprintf("%v", repoIdentifier), -1)
