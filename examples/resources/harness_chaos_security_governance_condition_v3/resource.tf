...
resource "harness_chaos_security_governance_condition_v3" "k8s_condition" {
  org_id      = var.org_id
...
resource "harness_chaos_security_governance_condition_v3" "linux_condition" {
  org_id      = var.org_id
  project_id  = var.project_id
...
output "k8s_condition_v3_id" {
  value = harness_chaos_security_governance_condition_v3.k8s_condition.id
}

output "linux_condition_v3_id" {
  value = harness_chaos_security_governance_condition_v3.linux_condition.id
}
